-- Fix manual order item source after order_items source enum rename.
--
-- Keep the manual order request item_type vocabulary as 'inventory', but
-- persist listing-backed order_items with the constrained source value.
begin;
