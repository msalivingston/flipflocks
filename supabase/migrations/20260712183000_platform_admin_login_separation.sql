-- Separate platform-admin eligibility from seller dashboard context.
-- Platform admins are user_roles rows with role = 'admin' and store_id is null.
...
'Authenticated helper for browser login routing. Returns true only for platform admin roles stored in public.user_roles.';
