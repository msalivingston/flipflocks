-- Group 66C follow-up: qualify seller manual order ambiguous identifiers
--
-- Avoid bare conflict target/column references inside seller_create_manual_order.
-- PL/pgSQL can otherwise resolve names such as store_id against output columns
-- as well as table columns and raise SQLSTATE 42702.
