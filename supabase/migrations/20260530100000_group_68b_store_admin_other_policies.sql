-- Group 68B: Store Admin V1 other policies support
--
-- Scope:
-- - Adds a single nullable seller-managed other_policies field to stores.
-- - Extends the existing seller context and seller settings RPCs to read/update it.
-- - Keeps this intentionally narrow; specific future policy fields remain deferred.
...
'Optional seller-managed public policy text for Store Admin V1 when pickup and cancellation policy fields are not enough.';
