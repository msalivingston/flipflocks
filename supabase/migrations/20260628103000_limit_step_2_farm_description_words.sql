-- Limit Step 2 farm descriptions to 250 words.
...
'Trusted seller onboarding Step 2 bootstrap. Creates or updates the authenticated user draft store, creates seller role membership, and marks profile setup complete with a required 250-word farm description, without creating billing or Stripe records.';
