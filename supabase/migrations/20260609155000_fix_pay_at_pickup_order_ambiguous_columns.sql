...
begin
  ...
  if exists (
    ...
    where locked_order_items.item_type = 'listing_inventory'
      and (
        (locked_order_items.batch_type = 'hatching_eggs' and locked_order_items.inventory_type <> 'hatching_eggs')
        or (locked_order_items.batch_type = 'live_animals' and locked_order_items.inventory_type = 'hatching_eggs')
      )
  ) then
