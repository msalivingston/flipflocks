-- Route seller_new_order to the authenticated store owner's current account
-- email. Other order-email recipient contracts remain unchanged.
...
begin
  ...
  v_recipient_email := case
    ...
    when v_notification_type = 'seller_new_order' then (
