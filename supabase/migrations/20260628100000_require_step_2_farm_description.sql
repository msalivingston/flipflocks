-- Require farm description during Step 2 seller onboarding.
--
-- Keeps the existing Step 2 bootstrap behavior, but requires about_text and
-- leaves it as text with no artificial character limit.
...
'Trusted seller onboarding Step 2 bootstrap. Creates or updates the authenticated user draft store, creates seller role membership, and marks profile setup complete with required farm description, without creating billing or Stripe records.';
