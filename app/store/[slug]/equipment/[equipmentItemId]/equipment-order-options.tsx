...
export function EquipmentOrderOptions({
  ...
  const selectedItem =
    selectedQuantity > 0
      ? toCartItem(item, selectedQuantity)
      : null;
          ...
          <table className="w-full table-fixed border-collapse text-left text-sm">
            <thead>
              <tr className="border-b border-[#e7decd] bg-[#fbf7ef] text-stone-950">
                ...
                <TableHeading>Condition</TableHeading>
            ...
            <tbody>
              <tr>
                ...
                <TableCell>{item.condition || "Not listed"}</TableCell>
...
function toCartItem(
  ...
  return {
    ...
    itemId: item.equipment_inventory_item_id,
    inventoryItemId: item.equipment_inventory_item_id,
    productId: item.equipment_inventory_item_id,
    productName: item.item_name,
    speciesName: null,
    optionLabel: item.condition ? `${item.category} - ${item.condition}` : item.category,
    ageLabel: null,
