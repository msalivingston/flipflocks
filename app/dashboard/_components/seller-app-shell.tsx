...
function SellerShellContent({ children }: { children: React.ReactNode }) {
  ...
  const isFocusedInventoryForm =
    ...
    pathname.startsWith("/dashboard/listings/new/birds/hatching-eggs") ||
    pathname.startsWith("/dashboard/listings/new/processed-poultry") ||
    pathname.startsWith("/dashboard/listings/new/equipment-supplies");
